    ...
    <main>
      <div className='h-hero relative'>
        ...
        <div className='flex w-full h-full items-center justify-center child:z-10'>
          <MaxWidthContainer>
            <h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl my-6 text-center font-extrabold'>Ashoka Racquet Sports League</h1>
          </MaxWidthContainer>
        </div>
      </div>
      <MaxWidthContainer className='mt-16'>
        <p className='text-lg text-center text-content'>
          Welcome to the Ashoka Racquet Sports League, where badminton, tennis, squash, and table tennis come together for a dynamic sporting
          experience. Join us in celebrating the joy of play and friendly competition in this one-of-a-kind league!
        </p>
        ...
        <div className='max-w-[40ch] mx-auto lg:max-w-none lg:grid lg:grid-cols-3 mb-12'>
          <PrizeBubble className='w-[95%] lg:w-full lg:left-[100%]' src={bubbles} prize='25,000' textClassName='text-gold' description='1st Place' />
